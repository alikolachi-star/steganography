...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow hover:bg-emerald-400 hover:shadow-emerald-500/25",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-slate-700/80",
        outline:
          "border border-border bg-transparent hover:bg-secondary hover:border-emerald-500/30",
        ghost: "hover:bg-secondary hover:text-foreground",
        destructive:
          "bg-destructive text-white hover:bg-red-500/90",
      },
      size: {
